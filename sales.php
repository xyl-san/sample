            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="row justify-content-center">
                        <h1 style="text-align:center; text-shadow: 2px 3px 8px #A1E14D;">Sales</h1>
                        <!-- this is a chart -->
                ...
                <div class="card-body ">
                    <button type="button" class="btn btn-success btn-sm btn-flat mt-2" data-bs-toggle="modal"
                        data-bs-target="#newTrialModal">
                        <span>
                            <i class="fa-solid fa-pen-to-square"></i>
                            TRIAL CREATE JOURNAL
                        </span>
                    </button>
                    <div class="card-body">
                        ...
                        <table id="journalList" class="table" style="width:100%">
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <th></th>
                                    <th></th>
                                    <th class="text-center">Total: <?php salesInfoTotal() ?></th>
