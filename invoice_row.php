<?php 
	...
	if(isset($_POST['id'])){
        ...
        inv.amount_total, inv.currency, inv.invoice_date,inv.due_date, inv.terms, inv.payment_reference, inv.invoice_notes, emp.employee_id, emp.firstname, emp.lastname, 
        ...
        INNER JOIN account_list AS acc on inv.account_id = acc.account_id WHERE invoice_id = '$invoiceId'";
