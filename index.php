        ...
        <div class="row justify-content-start">
            ...
            <div class="col-lg-2 col-md-3 col-sm-4 col-xs-6">
                <a href="inventory.php">
                    <button class="btn" id="crm">
                        <img src="assets/icons/inventory.png" alt="" style="height:120px">
            ...
            <div class="col-lg-2 col-md-3 col-sm-4 col-xs-6">
                <a href="attendance_list.php">
                    <button class="btn" id="crm">
                        <img src="assets/icons/attendance.png" alt="" style="height:120px">
            ...
            <div class="col-lg-2 col-md-3 col-sm-4 col-xs-6">
                <button class="btn" id="crm">
                    <img src="assets/icons/accounting.png" alt="" style="height:120px">
                    <div class="o_caption">Accounting</div>
                </button>
            </div>
            <div class="col-lg-2 col-md-3 col-sm-4 col-xs-6">
                <button class="btn" id="crm">
                    <img src="assets/icons/payroll.png" alt="" style="height:120px">
            ...
            <div class="col-lg-2 col-md-3 col-sm-4 col-xs-6">
                <button class="btn" id="crm">
                    <img src="assets/icons/sales.png" alt="" style="height:120px">
                    <div class="o_caption">Sales</div>
                </button>
            </div>
            <div class="col-lg-2 col-md-3 col-sm-4 col-xs-6">
                <button class="btn" id="crm">
                    <img src="assets/icons/employees.png" alt="" style="height:120px">
            ...
            <div class="col-lg-2 col-md-3 col-sm-4 col-xs-6">
                <button class="btn" id="crm">
                    <img src="assets/icons/invoices.png" alt="" style="height:120px">
                    <div class="o_caption">Invoices</div>
                </button>
            </div>
            <div class="col-lg-2 col-md-3 col-sm-4 col-xs-6">
                <button href="#" class="btn" id="crm">
                    <img src="assets/icons/purchase.png" alt="" style="height:120px">
