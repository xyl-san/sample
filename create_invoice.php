                            ...
                            <form class="row g-3" action="includes/queries.php" method="POST" autocomplete="off"
                                ...
                                <div class="col-md-10">
                                    <div class="input-group">
                                        <span class="input-group-text cusInvoiceID" name="cus_invoice_id">Customer
                                            Invoice Number</span>
                                        <input type="text" class="form-control invoiceId text-dark" name="invoice_id"
                                            readonly
                                            value="INV-<?php echo (new DateTime())->format('mY'); ?>-00<?php invoiceCode();?>"
                                    ...
                                    <div class="row g-2 m-1">
                                        ...
                                        <div class=" col-6 py-1 form-floating">
                                            <input type="number" class="form-control customerContact"
                                                name="customer_contact" id="customer_phone" required>
                                ...
                                <div class="card shadow p-3 mb-2 bg-body rounded" id="scrollspyHeading2">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="row form-group form-group-sm  no-margin-bottom">
                                                    ...
                                                    <div class="col-10">
                                                        <select class="form-control form-group-sm invoice_product"
                                                    ...
                                                    <div class="col-auto">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" class="form-control calculate-sub"
                                                                name="invoice_product_sub[]" value="0.00"
                                    ...
                                    <div class="float-end col-3 px-6 ">
                                        ...
                                        <div class="py-1">
                                            <div
                                                class="row form-control p-3 bg-success bg-gradient text-white bg-opacity-50">
                                                <div class="">
                                                    <strong>Total</strong>
                                                </div>
